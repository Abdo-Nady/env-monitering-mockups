...
const ELEMENT_DATA: PeriodicElement[] = [
  { position: 1, port: 'ميناء 1', dateTime: '2026-04-17 08:00', source: 'جهاز جودة الهواء - رصيف 1 بيتا 52', moniteringElements: 'رياح - m/s', measurementRate: 'معدل الأمن', actions: 'edit', IntegrationMechanism: '100' },
  { position: 2, port: 'ميناء 2', dateTime: '2026-04-17 09:00', source: 'محطة الأرصاد الجوية - بورسعيد', moniteringElements: 'CO2 - ppm', measurementRate: 'معدل التحذير', actions: 'edit', IntegrationMechanism: '200' },
  { position: 3, port: 'ميناء 3', dateTime: '2026-04-17 10:00', source: 'بلاغ', moniteringElements: 'غبار - mg/m^3', measurementRate: 'معدل الخطر', actions: 'edit', IntegrationMechanism: '300' },
];
...
@Component({
  selector: 'app-search-monitoring-operations',
  standalone: true,
  imports: [CommonModule, FormsModule, MatTableModule, MatPaginatorModule],
  templateUrl: './search-monitoring-operations.html',
  styleUrl: './search-monitoring-operations.css',
})
export class SearchMonitoringOperations {
  displayedColumns: string[] = ['position', 'port', 'dateTime','source', 'moniteringElements', 'IntegrationMechanism', 'measurementRate', 'actions'];
